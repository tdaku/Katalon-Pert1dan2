...
WebUI.setText(findTestObject('Checkout/textfield_billing_postcode'), '')
...
WebUI.verifyElementVisible(findTestObject('Checkout/text_validation_checkout'), FailureHandling.STOP_ON_FAILURE)
